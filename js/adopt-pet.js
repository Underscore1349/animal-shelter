...
// -------------------------------------------------------------------------------------------------------------------
    ...
    $('.ask-your-self-box').mouseenter(function () {
        $(this).find('.ask-your-self-box-title').css({ top: '15%', position: 'relative'});
        $(this).find('.ask-your-self-box-description').css('display', 'block');
    }).mouseleave(function () {
        $(this).find('.ask-your-self-box-title').css({ top: '80%', position: 'absolute' });
        $(this).find('.ask-your-self-box-description').css('display', 'none');
    });
